...
# Type: Font
c.fonts.prompts = 'default_size UbuntuMono Nerd Font'
...
config.bind('M', 'hint links spawn mpv --ytdl-format="bestvideo[height<=1080]+bestaudio/best[height<=1080]" {hint-url}')
config.bind('Z', 'hint links spawn kitty -e youtube-dl -o "~/Videos/%(title)s.%(ext)s" {hint-url}')
